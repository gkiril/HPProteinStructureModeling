 ...
 * @author Kiro
 */
public class InputProteinForm3 extends javax.swing.JFrame {

    /** Creates new form InputAminoAcidForm */
    public InputProteinForm3() {
        initComponents();
    ...
    private void createButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createButtonActionPerformed
        ...
        try{
            ...
            if ((binaryRadioButton.isSelected()==true) &&
                ...
                Protein3 A = new Protein3(jTextField1.getText());
                if (A.isCorrectBinary()){
                    try{
                        String msg = A.WriteFile2D(A.getq() + "_2D_Model3.lp");
            ...
            if ((binaryRadioButton.isSelected()==true) &&
                ...
                if (A.isCorrectBinary()){
                try{
                    String msg = A.WriteFile3D(A.getq() + "_3D_Model3.lp");
                    String txt = jTextArea1.getText();
                    if (txt == null ? "" != null : !txt.equals(""))
                        jTextArea1.setText(txt + 
                                "\n-----------------------------------------\n"
    ...
    */
    public static void Main() {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InputProteinForm3().setVisible(true);
            }
        });
    }
